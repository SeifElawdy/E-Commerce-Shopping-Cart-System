          ...
          <table class="table table-bordered m-0">
            <thead>
              <tr>
                ...
                <th class="text-right py-3 px-4" style="width: 100px;">ِActions</th>
              </tr>
            </thead>
            <tbody>
              <!-- --------------php------------------ -->
              ...
              ?>
                <tr>
                  ...
                  ?>
                  <td class="text-center align-middle px-0"><a href="cart_process.php?delete=true&product_ID=<?= $item['id'] ?>" class="shop-tooltip close float-none text-danger" title="" data-original-title="Remove">×</a>
