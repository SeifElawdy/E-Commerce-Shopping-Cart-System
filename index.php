...
<nav class="navbar navbar-expand-lg navbar-light bg-light px-3">
    <div class="container-fluid px-0">
        ...
        <!-- Right buttons: User + Cart + Login/Logout -->
        <div class="d-flex ms-auto pe-2 align-items-center">

            <!-- ✅ عرض اسم اليوزر + أيقونة -->
            <?php if (isset($_SESSION['user_name'])): ?>
                <div class="d-flex align-items-center me-3">
                    <i class="bi bi-person-circle fs-1 me-2 text-primary"></i> <!-- أيقونة يوزر -->
                    <span class="fw-bold text-primary fs-4"><?= htmlspecialchars($_SESSION['user_name']) ?></span> <!-- اسم اليوزر -->
                </div>
            <?php endif; ?>
            <!-- ✅ نهاية الجزء -->

            
            <!-- ✅ زر Dashboard يظهر فقط للـ admin -->
            <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'admin'): ?>
                <a href="Admin/dashboard.php" class="btn btn-warning me-2">Dashboard</a>
                <?php endif; ?>
                <!-- ✅ نهاية الجزء -->
                
                <!-- Cart Button -->
                <form class="me-2" action="cart/cart.php" method="post">
                    <button class="btn btn-outline-dark" type="submit">
                        <i class="bi-cart-fill me-1"></i>
                        Cart
                        <?php
                        $product_number = $_SESSION['product_number'] ?? 0;
                        ?>
    ...
    <footer class="py-5 bg-dark">
        <div class="container">
            <p class="m-0 text-center text-white">Copyright &copy; Seif's Website</p>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
